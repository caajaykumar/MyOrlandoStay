    ...
    <>
      ...
      <section className="get_contact_area">
            <Head>
                ...
                {/* You might want to link your own CSS file here as well */}
            ...
            <div className="container">
                <div className="row get_contact_inner">
                    <div className="col-md-6">
                        ...
                        <form className="contact_us_form row m0" action="" method="post" id="contactForm" noValidate="novalidate">
                            ...
                            <div className="form-group col-md-6 input-append date form_datetime">
                                <input size="16" type="date" id="ToTime" name="ToTime" placeholder="TO" />
                            </div>

                            <div className="form-group col-md-12">
                                <input type="number" className="form-control" id="NoPeople" name="NoPeople" placeholder="Number of People" />
                            </div>
                            <div className="form-group col-md-12">
                                <input type="text" className="form-control" id="sContact" name="sContact" placeholder="Contact Number" />
                            </div>
                            <div className="form-group col-md-12">
                                <textarea className="form-control" id="sMassage" name="sMassage" rows="1" placeholder="Message"></textarea>
                            </div>
                            ...
                            <div className="form-group col-md-12">
                                <button type="submit" value="submit" id="submit" className="btn submit_btn form-control">submit now</button>
                            </div>
                        </form>
                    </div>
